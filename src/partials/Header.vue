    ...
    >
      <div class="flex flex-row flex-1 justify-between items-center">
        ...
        <div>
          ...
          <button id="drawer" class="lg:hidden">
            <svg
              height="64"
              width="64"
              fill="currentColor"
      ...
      <nav class="flex flex-col lg:flex lg:flex-row lg:items-center">
        <button name="about" class="btn btn-ghost">About</button>
        <button name="experience" class="btn btn-ghost">Experience</button>
        <button name="portfolio" class="btn btn-ghost">Portfolio</button>
        <button name="skills" class="btn btn-ghost">Skills</button>
        <button name="contact" class="btn btn-ghost">Contact</button>
      </nav>
